...
export const SMS_PVX_MAPPING_BUILD = 'CF-DISCOVERY-1.0';
export const SMS_PVX_MAPPING_SCHEMA = '1.0';
export const SMS_PVX_MAPPING_CONTRACT = 'coveragefit-sms-pvx-mapping-v1';
export const SMS_PVX_ALLOWED_INTENTS = Object.freeze(['buyer', 'home_review', 'bundle', 'auto']);
...
export function mapSmsToPvx(source = {}, options = {}) {
  ...
  return {
    ...
    destination: canEnterPvx ? '/pvx/discovery/' : '',
    journey: {
      journeyId: text(source.journeyId, 120),
      currentStage,
      completedStages: [],
      resumeState: { status: 'active', exactStage: currentStage, exactStep: canEnterPvx ? discovery.currentQuestionId : 'producer_handling' },
...
export function validateSmsPvxMapping(mapping = {}) {
  ...
  if (mapping.canEnterPvx && mapping.destination !== '/pvx/discovery/') errors.push('destination');
